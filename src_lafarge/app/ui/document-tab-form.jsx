...
DocumentTabForm.Field = class DocumentTabFormField extends React.Component {
    render() {
        var label = getChildOfComponentType(this.props.children, DocumentTabFormLabel);
        var control = getChildOfComponentType(this.props.children, DocumentTabFormControl);

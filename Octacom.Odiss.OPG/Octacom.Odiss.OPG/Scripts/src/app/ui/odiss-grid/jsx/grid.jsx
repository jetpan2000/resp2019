...
const ThComponent = ({ children, toggleSort, className }) => {
    ...
    return <div className="rt-th rt-resizable-header">
        <div className="rt-resizable-header-content">
            ...
            <FontAwesomeIcon className={classNames({ 'sort-icon': true, 'is-sorted': isSorted })} onClick={toggleSort} icon={icon} rotation={rotation} pull="right" size="lg" />
        </div>
    </div>
